...
import { SecretCipherService } from '@app/shared/infrastructure/security/secret-cipher.service';
import { LlmConfiguration } from '@app/modules/projects/builder/domain/entities/llm-configuration.entity';
import type { ILlmConfigurationRepository } from '@app/modules/projects/builder/domain/repositories/llm-configuration.repository.interface';
...
describe('BuilderLlmConfigService — vencimiento de la caché', () => {
  ...
  function build() {
    ...
    const service = new (jest.requireActual<{
      ...
      '@app/modules/projects/builder/application/services/config/builder-llm-config.service',
