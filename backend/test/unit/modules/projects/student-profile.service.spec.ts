...
import {
  ...
  UserRole,
  UserStatus,
} from '@app/modules/users/entities/user.entity';
import type { IUserRepository } from '@app/modules/users/domain/repositories/user.repository.interface';
import type { GroupRosterReader } from '@app/shared/application/group-roster-reader.port';
...
import { StudentProfileService } from '@app/modules/projects/student-profile.service';
