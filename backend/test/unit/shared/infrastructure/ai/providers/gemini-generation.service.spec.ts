import { GeminiGenerationService } from '@app/shared/infrastructure/ai/providers/gemini-generation.service';
import { postJson } from '@app/shared/infrastructure/ai/llm-request.util';

jest.mock('@app/shared/infrastructure/ai/llm-request.util', () => {
  const actual = jest.requireActual(
    '@app/shared/infrastructure/ai/llm-request.util',
  );
  return {
    ...actual,
    postJson: jest.fn(),
