...
import { TechnicalFindingCard } from '@/reporting/components/report/TechnicalFindingCard';
import { normalizeTechnicalFeedbackItem } from '@/reporting/utils/technicalFeedback';
