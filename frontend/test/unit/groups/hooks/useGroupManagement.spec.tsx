...
import { renderHookWithProviders } from "@test/support/renderWithProviders";

vi.mock("@/groups/api/groupsApi", () => ({
  groupsApi: {
    list: vi.fn(),
    create: vi.fn(),
    update: vi.fn(),
...
import { useGroupManagement } from "@/groups/hooks/useGroupManagement";
