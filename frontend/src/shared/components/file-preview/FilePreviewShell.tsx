 ...
 * `useFocusTrap` permanece activo mientras el shell está montado para
 * mantener el foco de teclado dentro del diálogo.
 */
export function FilePreviewShell({
  ...
  return (
    ...
    >
      {header}
      {/*
 overflow-x-auto, no overflow-hidden: FileExplorer (w-64/72)
