# Setup global de tests (`src/test/`)
...
├── setup.spec.ts             # Smoke test de que el propio entorno de test arrancó bien
...
- [`../shared/query/README.md`](../shared/query/README.md) — `queryDefaultOptions`, la base que reutiliza `createTestQueryClient()`.
