  ...
  return (
    <div className="min-h-screen bg-app-bg">
      <div className="mx-auto flex min-h-screen max-w-7xl items-center justify-center px-5 py-10 sm:px-6 lg:px-8">
        <div className="w-full max-w-md rounded-[2rem] border border-slate-400/25 bg-white p-8 shadow-md sm:p-10">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-app-border bg-app-bg-subtle">
              <img
